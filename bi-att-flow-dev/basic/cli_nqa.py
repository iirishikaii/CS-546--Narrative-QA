...
flags.DEFINE_integer("num_sents_th", 50, "num sents th [8]")
flags.DEFINE_integer("ques_size_th", 30, "ques size th [32]")
flags.DEFINE_integer("word_size_th", 34, "word size th [16]")
flags.DEFINE_integer("para_size_th", 1247, "para size th [256]")
