...
from basic.main_nqa import main as m

flags = tf.app.flags

# Names and directories
flags.DEFINE_string("model_name", "basic", "Model name [basic]")
flags.DEFINE_string("data_dir", "data/narrativeqa", "Data dir [data/narrativeqa]")
...
flags.DEFINE_integer("batch_size", 5, "Batch size [60]")
flags.DEFINE_integer("val_num_batches", 50, "validation num batches [100]")
flags.DEFINE_integer("test_num_batches", 0, "test num batches [0]")
flags.DEFINE_integer("num_epochs", 6, "Total number of epochs for training [12]")
...
flags.DEFINE_integer("hidden_size", 40, "Hidden size [100]")
flags.DEFINE_integer("char_out_size", 50, "char-level word embedding size [100]")
...
#TODO: need to change these thresholds, for our case?
