...
class Evaluation(object):
    def __init__(self, data_type, global_step, idxs, answers, tensor_dict=None):
        self.data_type = data_type
        self.global_step = global_step
        self.idxs = idxs
        self.yp = answers
        self.num_examples = len(answers)
...
class Evaluator(object):
    ...
    def get_evaluation(self, sess, batch):
        ...
        global_step, answers, vals = sess.run([self.global_step, self.translations, list(self.tensor_dict.values())], feed_dict=feed_dict)
        answers = answers[:data_set.num_examples]
        tensor_dict = dict(zip(self.tensor_dict.keys(), vals))
        e = Evaluation(data_set.data_type, int(global_step), idxs, answers.tolist(), tensor_dict=tensor_dict)
        return e
